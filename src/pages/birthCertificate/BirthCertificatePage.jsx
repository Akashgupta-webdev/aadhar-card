...
export default function BirthCertificatePage() {
  ...
  const fetchBirthCertificate = async () => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .select("id, name, dob, fatherName, created_at")
        .eq("user_id", user.id)
  ...
  const handleOpen = (id) => {
    console.log("id:", id);
    navigate(`/birth-certificate-detail/${id}`);
  };

  const handleEdit = (id) => {
    navigate(`/birth-certificate-edit/${id}`);
  };
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Manage and view your birth certificate information securely
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button className="flex items-center gap-2" onClick={() => navigate("/birth-certificate-form")}>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{birthCertificateData.length}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-semibold">
                  {birthCertificateData.length > 0
                    ? formatDate(birthCertificateData[0].created_at)
                    : "N/A"}
                </p>
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your stored Birth Certificate records with secure access controls
          </CardDescription>
        </CardHeader>
        <CardContent>
          {birthCertificateData.length === 0 ? (
            <div className="text-center py-12 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Get started by adding your first Birth Certificate record.
                </p>
              </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="w-[150px]">Father Name</TableHead>
                    <TableHead className="w-[150px]">Create Date</TableHead>
                ...
                <TableBody>
                  {birthCertificateData.map((client) => (
