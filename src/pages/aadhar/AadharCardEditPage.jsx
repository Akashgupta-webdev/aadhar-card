  ...
  useEffect(() => {
    const fetchAadharDetails = async () => {
      try {
        ...
        if (data) {
          setName(data[0].name);
          setPreviewImage(data[0].image_url);
          setCompleteAddress(data[0].complete_address);
          setDob(new Date(data[0].dob));
          setGender(data[0].gender);
          setLocalLanguageName(data[0].local_language_name);
          setLocalLanguageAddress(data[0].local_language_address);
          setLocalLanguageGender(data[0].local_language_gender);
          setLocalLanguageAddress(data[0].local_language_address_label);
          setLocalLanguageDob(data[0].local_language_dob_label);
        }
      } catch (error) {
